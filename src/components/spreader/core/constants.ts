...
export const i18n: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    nfCatNumber: '数值',
    nfCatCurrency: '货币',
    nfCatAccounting: '会计专用',
    nfCatFinancial: '财务',
    nfCatPercent: '百分比',
    nfCatScientific: '科学计数',
    nfCatDate: '日期',
    nfCatTime: '时间',
    nfCatText: '文本',
    nfCatCurrencyRounded: '货币取整',
    nfCatDateTime: '日期和时间',
    nfCatDuration: '持续时间',
    nfCatCustom: '自定义',
    nfDecimals: '小数位数',
  ...
  'en-US': {
    ...
    nfCategory: 'Category',
    nfCatGeneral: 'General',
    nfCatNumber: 'Number',
    nfCatCurrency: 'Currency',
    nfCatAccounting: 'Accounting',
    nfCatFinancial: 'Financial',
    nfCatPercent: 'Percentage',
    nfCatScientific: 'Scientific',
    nfCatDate: 'Date',
    nfCatTime: 'Time',
    nfCatText: 'Text',
    nfCatCurrencyRounded: 'Currency Rounded',
    nfCatDateTime: 'Date & Time',
    nfCatDuration: 'Duration',
    nfCatCustom: 'Custom',
