    ...
    <Teleport to="body">
      <Transition name="menu-pop">
        <div
          v-if="open"
          ref="menuRef"
          class="border-picker__menu sp-spreader-overlay"
    ...
    <Teleport to="body">
      <Transition name="border-sub-pop">
        <div
          v-if="open && colorSub"
          ref="colorSubRef"
          class="border-submenu-wrap sp-spreader-overlay"
          :class="{ 'border-submenu-wrap--left': colorSubDir === 'left', 'border-submenu-wrap--up': colorSubUp, 'dark': spTheme === 'dark' }"
          :style="{
    ...
    <Teleport to="body">
      <Transition name="border-sub-pop">
        <div
          ...
          ref="lineSubRef"
          class="border-submenu-wrap sp-spreader-overlay"
          :class="{ 'border-submenu-wrap--left': lineSubDir === 'left', 'border-submenu-wrap--up': lineSubUp, 'dark': spTheme === 'dark' }"
          :style="{
